...
class PayoutSuccessView extends StatefulWidget {
  const PayoutSuccessView({super.key});

  @override
  State<PayoutSuccessView> createState() => _PayoutSuccessViewState();
}

class _PayoutSuccessViewState extends State<PayoutSuccessView> {
  late final PayoutController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<PayoutController>();
    // auto navigate to driver home after short delay
