...
class MoverHelpView extends GetView<MoverSettingsController> {
  const MoverHelpView({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _field(
                ctrl.supportEmail,
                hint: 'mover-support@digaxy.com',
                readOnly: true,
                onTap: () {
                  final email = ctrl.supportEmail.text.isNotEmpty
                      ? ctrl.supportEmail.text
                      : 'support@digaxy.com';
              ...
              SizedBox(height: 8.h),
              _multilineField(ctrl.supportMessage),
              SizedBox(height: 20.h),
              PrimaryButton(label: 'Send', onPressed: () => ctrl.sendSupport()),
            ],
          ),
        ),
      ),
