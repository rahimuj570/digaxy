...
class MoverSettingsView extends StatelessWidget {
  const MoverSettingsView({super.key});

  @override
  Widget build(BuildContext context) {
    // ensure controller is available even if binding wasn't applied
                ...
                child: ListView(
                  ...
                  children: [
                    ListTile(
                      ...
                      onTap: () =>
                          Get.toNamed(Routes.MOVER_SETTINGS_CHANGE_PASSWORD),
                    ),
                    ListTile(
                      leading: Icon(
                      ...
                      onTap: () => Get.toNamed(Routes.MOVER_SETTINGS_PRIVACY),
                    ),
                    ListTile(
                      leading: Icon(
                      ...
                      onTap: () => Get.toNamed(Routes.MOVER_SETTINGS_TERMS),
                    ),
                    ListTile(
                      leading: Icon(
                        Icons.help_outline,
                      ...
                      onTap: () => Get.toNamed(Routes.MOVER_SETTINGS_HELP),
                    ),
                    ListTile(
